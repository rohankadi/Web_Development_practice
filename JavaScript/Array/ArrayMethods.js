...
let num = [50, 80, 60, 100, 10, 20];
numSortingInAsc = num.sort(function(a,b){
    return a-b;
})
console.log("After sorting in ascending order :", numSortingInAsc);

numSortingInDesc = num.sort(function(a, b){
    return b-a;
})
console.log("After sorting in descending order :", numSortingInDesc);
